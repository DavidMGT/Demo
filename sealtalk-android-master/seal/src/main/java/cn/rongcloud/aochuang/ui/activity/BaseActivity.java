...
import cn.rongcloud.aochuang.server.SealAction;
import cn.rongcloud.aochuang.server.network.async.AsyncTaskManager;
import cn.rongcloud.aochuang.server.network.async.OnDataListener;
...
public abstract class BaseActivity extends FragmentActivity implements OnDataListener {
     ...
     * @param visibility
     */
    public void setRightCustomerVisiablity(int visibility) {
  ...
  /*  点击了联系客服*/
    ...
    public void onHeadCustomerButtonClick(View view) {
     ...
     * @param view
     */
    public void onHeadCheckReportButtonClick(View view) {
