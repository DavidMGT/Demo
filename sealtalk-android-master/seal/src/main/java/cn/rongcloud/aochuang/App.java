...
import cn.rongcloud.aochuang.message.provider.TestMessageProvider;
import cn.rongcloud.aochuang.server.pinyin.CharacterParser;
import cn.rongcloud.aochuang.server.utils.NLog;
import cn.rongcloud.aochuang.server.utils.RongGenerate;
import cn.rongcloud.aochuang.stetho.RongDatabaseDriver;
import cn.rongcloud.aochuang.stetho.RongDatabaseFilesProvider;
...
//            LeakCanary.install(this);//内存泄露检测
            ...
            options = new DisplayImageOptions.Builder()
                    .showImageForEmptyUri(cn.rongcloud.aochuang.R.drawable.de_default_portrait)
                    .showImageOnFail(cn.rongcloud.aochuang.R.drawable.de_default_portrait)
                    .showImageOnLoading(cn.rongcloud.aochuang.R.drawable.de_default_portrait)
