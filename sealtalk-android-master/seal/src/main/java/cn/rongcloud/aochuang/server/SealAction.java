package cn.rongcloud.aochuang.server;
...
import cn.rongcloud.aochuang.server.request.AgreeFriendsRequest;
import cn.rongcloud.aochuang.server.request.ChangePasswordRequest;
import cn.rongcloud.aochuang.server.request.CheckPhoneRequest;
import cn.rongcloud.aochuang.server.request.CreateGroupRequest;
import cn.rongcloud.aochuang.server.request.DeleteFriendRequest;
import cn.rongcloud.aochuang.server.request.DeleteGroupMemberRequest;
import cn.rongcloud.aochuang.server.request.DismissGroupRequest;
import cn.rongcloud.aochuang.server.request.FriendInvitationRequest;
import cn.rongcloud.aochuang.server.request.JoinGroupRequest;
import cn.rongcloud.aochuang.server.request.LoginRequest;
import cn.rongcloud.aochuang.server.request.QuitGroupRequest;
import cn.rongcloud.aochuang.server.request.RegisterRequest;
import cn.rongcloud.aochuang.server.request.RemoveFromBlacklistRequest;
import cn.rongcloud.aochuang.server.request.RestPasswordRequest;
import cn.rongcloud.aochuang.server.request.SendCodeRequest;
import cn.rongcloud.aochuang.server.request.SetFriendDisplayNameRequest;
import cn.rongcloud.aochuang.server.request.SetGroupDisplayNameRequest;
import cn.rongcloud.aochuang.server.request.SetGroupNameRequest;
import cn.rongcloud.aochuang.server.request.SetGroupPortraitRequest;
import cn.rongcloud.aochuang.server.request.SetNameRequest;
import cn.rongcloud.aochuang.server.request.SetPortraitRequest;
import cn.rongcloud.aochuang.server.request.VerifyCodeRequest;
import cn.rongcloud.aochuang.server.response.AddGroupMemberResponse;
import cn.rongcloud.aochuang.server.response.AddToBlackListResponse;
import cn.rongcloud.aochuang.server.response.AgreeFriendsResponse;
import cn.rongcloud.aochuang.server.response.ChangePasswordResponse;
import cn.rongcloud.aochuang.server.response.CheckPhoneResponse;
import cn.rongcloud.aochuang.server.response.CreateGroupResponse;
import cn.rongcloud.aochuang.server.response.DefaultConversationResponse;
import cn.rongcloud.aochuang.server.response.DeleteFriendResponse;
import cn.rongcloud.aochuang.server.response.DeleteGroupMemberResponse;
import cn.rongcloud.aochuang.server.response.DismissGroupResponse;
import cn.rongcloud.aochuang.server.response.FriendInvitationResponse;
import cn.rongcloud.aochuang.server.response.GetBlackListResponse;
import cn.rongcloud.aochuang.server.response.GetFriendInfoByIDResponse;
import cn.rongcloud.aochuang.server.response.GetGroupInfoResponse;
import cn.rongcloud.aochuang.server.response.GetGroupMemberResponse;
import cn.rongcloud.aochuang.server.response.GetGroupResponse;
...
import cn.rongcloud.aochuang.server.response.GetUserInfoByPhoneResponse;
...
import cn.rongcloud.aochuang.server.response.RemoveFromBlackListResponse;
import cn.rongcloud.aochuang.server.response.RestPasswordResponse;
